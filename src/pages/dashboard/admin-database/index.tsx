    ...
    <div className="p-6">
      ...
      <div className="flex justify-between items-start mb-8">
        <div>
          ...
          <p className="text-gray-600 mt-2">System backups and data integrity.</p>
        </div>
        <div className="flex gap-3">
          <button className="px-4 py-2.5 bg-gray-100 text-gray-700 rounded-lg font-semibold hover:bg-gray-200 transition-colors">
            Configuration
          </button>
          <button className="px-4 py-2.5 bg-orange-500 text-white rounded-lg font-semibold hover:bg-orange-600 transition-colors">
            Create Backup
          </button>
        </div>
      </div>
