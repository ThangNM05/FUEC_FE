    ...
    return (
        <div className="p-4 md:p-6">
            <div className="mb-4 md:mb-6">
                <h1 className="text-2xl md:text-3xl font-bold text-gray-900">Exam Type Management</h1>
                <p className="text-sm md:text-base text-gray-600 mt-1 md:mt-2">Manage exam types, duration, and weights.</p>
            </div>
