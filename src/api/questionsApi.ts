...
export const questionsApi = baseApi.injectEndpoints({
    endpoints: (builder) => ({
        ...
        // Step 1: Upload file → get preview (no DB save)
        ...
        importQuestions: builder.mutation<ImportQuestionBankResult, { subjectCode: string; selectedQuestions: ImportPreviewQuestion[] }>({
            query: (body) => ({
