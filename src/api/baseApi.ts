...
export const baseApi = createApi({
  ...
  tagTypes: ['Students', 'Teachers', 'Majors', 'SubMajors', 'Accounts', 'Rooms', 'Subjects', 'Syllabuses', 'Semesters', 'ExamFormats', 'Classes', 'ClassSubjectTeachers', 'StudentClasses', 'Curriculums', 'QuestionBanks', 'Question', 'TeachingSubjects'],
  endpoints: () => ({}),
});
