...
export default function CreateSyllabusModal({ isOpen, onClose }: CreateSyllabusModalProps) {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            // isApproved defaulting to false or backend default
    ...
    const handleChange = (e: React.ChangeEvent<HTMLInputElement | HTMLSelectElement | HTMLTextAreaElement>) => {
        ...
        setFormData(prev => ({
            ...prev,
            [name]: name === 'scoringScale' ? Number(value) : value
        }));
    };
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 overflow-y-auto">
            <div className="bg-white rounded-lg shadow-xl w-full max-w-2xl">
                <div className="flex justify-between items-center p-6 border-b">
                    <h2 className="text-xl font-semibold text-gray-900">Add New Syllabus</h2>
                ...
                <form onSubmit={handleSubmit} className="p-6 space-y-4">
                    ...
                    <div className="flex justify-end gap-3 pt-4 border-t mt-4">
                        ...
                        >
                            {isLoading ? 'Creating...' : 'Create Syllabus'}
                        </button>
                    </div>
                </form>
            </div>
