...
import { useUpdateRoomMutation } from '@/features/room-management/services/roomsApi';
import { Building, RoomStatus, RoomType, type Room } from '@/features/room-management/types/room.types';
